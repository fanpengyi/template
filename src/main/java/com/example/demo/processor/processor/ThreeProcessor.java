...
@Service
@Slf4j
public class ThreeProcessor extends AbstractTemplateProcessor<String> {
    ...
    protected Response<Void> doProcess(String useId) {
        log.info("执行 ThreeProcessor 的逻辑"+useId);
        DataHolder.get().getResultMaps().put("Three","ThreeProcessor");
